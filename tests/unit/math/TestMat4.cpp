...
BOOST_AUTO_TEST_CASE(Mat4)
{
    ...
    mat4f refC(__m128{29, 137, 245, 353}, __m128{31, 115, 199, 283}, __m128{23, 91, 159, 227},
               __m128{30, 118, 206, 294});
    std::cout << refC << std::endl;

    auto D = B * A;
    std::cout << D << std::endl;
    mat4f refD(__m128{116, 168, 100, 100}, __m128{138, 198, 122, 113}, __m128{160, 228, 144, 126},
