...
BOOST_AUTO_TEST_CASE(Get_Value)
{
    ...
    BOOST_CHECK_THROW(sse::GetValue(d128, 2), Exception);
    ...
    BOOST_CHECK_THROW(sse::GetValue(f128, 4), Exception);
    ...
    BOOST_CHECK_THROW(sse::GetValue(d256, 4), Exception);
    ...
    BOOST_CHECK_THROW(sse::GetValue(f256, 8), Exception);
#endif // __AVX2__
}
