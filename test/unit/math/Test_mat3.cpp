...
{
    ConstructionTest<Mat3Serial<F32>>();
}
...
BOOST_FIXTURE_TEST_CASE(Comparison_Serial, Fixture<Mat3Serial<F32>>)
{
    ComparisonTest(A, B);
}
...
BOOST_FIXTURE_TEST_CASE(Parentheses_Operator_Serial, Fixture<Mat3Serial<F32>>)
{
...
BOOST_FIXTURE_TEST_CASE(Addition_Assignment_Serial, Fixture<Mat3Serial<F32>>)
{
...
BOOST_FIXTURE_TEST_CASE(Addition_Serial, Fixture<Mat3Serial<F32>>)
{
    AdditionTest(A, B);
}
...
BOOST_FIXTURE_TEST_CASE(Multiplication_Serial, Fixture<Mat3Serial<F32>>)
{
    MultiplicationTest<Mat3Serial<F32>>(A, B);
}
...
BOOST_FIXTURE_TEST_CASE(Matrix_Vector_Multiplication_Serial, Fixture<Mat3Serial<F32>>)
{
    MatrixVectorMultiplicationTest<Mat3Serial<F32>, Vec3fSerial<true>>(A, B);
}
...
BOOST_FIXTURE_TEST_CASE(Transpose_Serial, Fixture<Mat3Serial<F32>>)
{
    Transpose<Mat3Serial<F32>>(A);
}
...
BOOST_FIXTURE_TEST_CASE(Determinant_Serial, Fixture<Mat3Serial<F32>>)
{
    Determinant<Mat3Serial<F32>>(A, B);
}
