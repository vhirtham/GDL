...
The dot product function uses the \mintinline{cpp}{ _mm_dp_ps} intrinsic function with a fitting mask. The implementation of the cross product looks like this:
