...
After obtaining $\mathbf{\bar{A}}$, another reflection $\mathbf{\bar{H}}$ is calculated which turns every value of the second column that is located below the main diagonal into zeros:
...
z  = {(0cm,1cm)},
scale = 1.5]
\fill [fill=black!30!white] (-1,-1,-0.4142) -- (-1,5,2.071) -- (5,5,2.071) -- (5,-1,-0.4142) -- (-1,-1,-0.4142);
\draw[color= black!15!white] (0,-1,-0.4142) -- (0,5,2.071);
...
\draw[color= black!15!white] (-1,1, 0.4142) -- (5,1,0.4142);
\draw[color= black!15!white] (-1,2, 0.8284) -- (5,2,0.8284);
\draw[color= black!15!white] (-1,3, 1.2426) -- (5,3,1.2426);
\draw[color= black!15!white] (-1,4, 1.6568) -- (5,4,1.6568);

\draw[-latex, very thick] (-1,0,0) -- (5,0,0);
\draw[very thick] (0,-1,0) -- (0,0,0);
\draw[-latex, dashed, very thick] (0,0,0) -- (0,5,0);
\draw[-latex, very thick] (0,0,0) -- (0,0,5);
\draw[dashed, very thick] (0,0,-1) -- (0,0,0);
\draw[dashed] (-1,0,0) -- (-1,5,0) -- (3.9,5,0);
\draw[] (3.8,5,0) -- (5,5,0) -- (5,-1,0) -- (-1,-1,0) -- (-1,0,0);

\draw[] (0,2,2) -- (3,2,2);
\draw[dashed] (0,2.83,0) -- (3,2.83,0);
\draw[dashed] (3,0,0) -- (3,5,0);
\draw[dashed] (0,2,0) -- (0,2,0.8284);
\draw[] (0,2,0.8284) -- (0,2,2);
\draw[dashed] (3,2,0) -- (3,2,0.8284);
\draw[] (3,2,0.8284) -- (3,2,2);
\draw[dashed] (0,2,0) -- (3,2,0);
\draw[color=red] (3,0,0) -- (3,2,2);


\draw[color=red,-latex, ultra thick] (0,0,0) -- (0,2,2);
\draw[color=blue,-latex, dashed, ultra thick] (0,0,0) -- (0,2.83,0);
\draw[color=green, dashed, ultra thick] (0,2.83,0) -- (0,2.415,1);
\draw[color=green, -latex, ultra thick] (0,2.415,1) -- (0,2,2);

\draw[color=red,-latex, ultra thick] (0,0,0) -- (3,2,2);
\draw[color=blue,-latex, dashed, ultra thick] (0,0,0) -- (3,2.83,0);
\draw[color=green, dashed, ultra thick] (3,2.83,0) -- (3,2.415,1);
\draw[color=green, -latex, ultra thick] (3,2.415,1) -- (3,2,2);

\node[] at (4.7,-0.5,0) {\large{x}};
\node[] at (-0.3,4.7,0) {\large{y}};
\node[] at (-0.3,0,4.5) {\large{z}};

\node[] at (4,0,4.75) {\large{reflection plane}};
\node[color=blue] at (2.5,0.9,0.2) {\Large{$\mathbf{Hx}$}};
\node[color=red] at (2.7,1.5,1.5) {\Large{$\mathbf{x}$}};
\node[color=green] at (4.1,2.1,1.9) {\Large{$\mathbf{x-Hx =w}$}};

\node[color=blue] at (-0.3,2,0.2) {\Large{$\mathbf{\dot{H}\dot{x}}$}};
\node[color=red] at (-0.3,1.5,1.5) {\Large{$\mathbf{\dot{x}}$}};
\node[color=green] at (0.9,2,2.2) {\Large{$\mathbf{\dot{x}-\dot{H}\dot{x}=\dot{w}}$}};
\end{tikzpicture}
\caption{Comparison of reflections on a reflection plane containing the x-axis.}
