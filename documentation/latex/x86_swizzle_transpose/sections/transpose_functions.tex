...
The approach is quite similar as in the previous case, but instead of reordering the input array \cppInline{a} we need to reorder the result array \cppInline{b} by moving the first register to the end a number of times equal to the input arrays offset.
