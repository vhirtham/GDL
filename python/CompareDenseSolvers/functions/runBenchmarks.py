...
def RunBenchmarks():
    ...
    with tempfile.TemporaryDirectory(dir=scriptDir) as buildDir:
        ...
        cmds += (
            "./benchmark/math/solver/Benchmark_gauss --benchmark_out_format=json --benchmark_out="
            + bmResultDir
            + "/Gauss.json;"
        )
        ...
        cmds += (
            "./benchmark/math/solver/Benchmark_lu --benchmark_out_format=json --benchmark_out="
            + bmResultDir
            + "/LU.json;"
        )
        ...
        cmds += (
            "./benchmark/math/solver/Benchmark_qr --benchmark_out_format=json --benchmark_out="
            + bmResultDir
            + "/QR.json;"
        )
