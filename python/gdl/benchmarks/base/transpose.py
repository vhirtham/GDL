"""Functions related to benchmarks of the 'GDL::Transpose' function'"""
...
from gdl.utility import filter_matching_strings
from gdl.x86 import num_register_elements, supported_registers
...
def benchmark_all_registers(
    ...
    """
    for register in supported_registers():
