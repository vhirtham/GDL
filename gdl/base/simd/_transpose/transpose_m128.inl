...
inline void Transpose1x2(__m128 in_0, __m128 in_1, __m128& out_0) noexcept
{
    ...
    else
    {
        if constexpr (_firstRowOut == 0)
        {
            ...
            {
                __m128 tmp0 = _mm_unpackhi(in_0, in_1);
        ...
        else
        {
            if constexpr (_firstRowIn == 0)
            {
                __m128 tmp0 = _mm_unpacklo(in_0, in_1);
...
inline void Transpose1x3(__m128 in_0, __m128 in_1, __m128 in_2, __m128& out_0) noexcept
{
    ...
    if constexpr (_firstRowOut == 0)
    {
        __m128 tmp0 = Shuffle<_firstRowIn, _firstRowIn, _firstRowIn, _firstRowIn>(in_1, in_2);
        tout = Insert<_firstRowIn, 0, false, false, false, true>(in_0, tmp0);
    }

    else
    {
        __m128 tmp0 = Shuffle<_firstRowIn, _firstRowIn, _firstRowIn, _firstRowIn>(in_0, in_1);
        tout = Insert<_firstRowIn, 3, true, false, false, false>(in_2, tmp0);
    }
...
inline void Transpose1x4(__m128 in_0, __m128 in_1, __m128 in_2, __m128 in_3, __m128& out_0) noexcept
{
    ...
    out_0 = Shuffle<0, 2, 0, 2>(tmp0, tmp1);
}
...
inline void Transpose2x3(__m128 in_0, __m128 in_1, __m128 in_2, __m128& out_0, __m128& out_1) noexcept
{
    ...
    if constexpr (_firstRowOut == 0)
    {
        tout[0] = Shuffle<0, s0, s2, 0>(tmp0, in_2);
        tout[1] = Shuffle<s1, 3, s3, 0>(tmp0, in_2);
    }
    else
    {
        tout[0] = Shuffle<0, s2, 0, s0>(in_0, tmp0);
        tout[1] = Shuffle<0, s3, s1, 3>(in_0, tmp0);
    }
...
{
    __m128 tmp0 = Shuffle<_firstRowIn, _firstRowIn + 1, _firstRowIn, _firstRowIn + 1>(in_0, in_1);
    __m128 tmp1 = Shuffle<_firstRowIn, _firstRowIn + 1, _firstRowIn, _firstRowIn + 1>(in_2, in_3);

    out_0 = Shuffle<0, 2, 0, 2>(tmp0, tmp1);
    out_1 = Shuffle<1, 3, 1, 3>(tmp0, tmp1);
}
...
inline void Transpose3x3(__m128 in_0, __m128 in_1, __m128 in_2, __m128& out_0, __m128& out_1, __m128& out_2) noexcept
{
    ...
    if constexpr (_firstRowOut == 0)
    {
        ...
        if constexpr (_firstRowIn == 0)
        {
            ...
            tout[idx_0] = Shuffle<2, 3, 3, 2>(tmp0, in_2);

        tout[idx_1] = BlendIndex<1>(tmp1, in_1);
        tout[idx_2] = BlendIndex<2>(tmp0, in_2);
    }
    else
    {
        __m128 tmp0 = _mm_unpacklo(in_1, in_2);
        __m128 tmp1 = Shuffle<2, 2, 2, 2>(in_0, in_2);

        if constexpr (_firstRowIn == 0)
            tout[idx_0] = Shuffle<1, 0, 0, 1>(in_0, tmp0);
        else
        {
        ...
        tout[idx_1] = BlendIndex<1>(tmp0, in_0);
                         ...
                         __m128& out_2) noexcept
{
    ...
    if constexpr (_firstRowIn == 0)
    {
        out_0 = _mm_movelh(tmp0, tmp2);
        out_1 = _mm_movehl(tmp2, tmp0);
        out_2 = _mm_movelh(tmp1, tmp3);
    }
    else
    {
        out_0 = _mm_movehl(tmp2, tmp0);
                         ...
                         __m128& out_3) noexcept
{
    ...
    if constexpr (_firstRowOut == 0)
    {
        ...
        tout[0] = _mm_movelh(tmp0, in_2);
        tout[1] = Shuffle<2, 3, 1, 0>(tmp0, in_2);
    ...
    else
    {
        ...
        tout[0] = Shuffle<1, 0, 0, 1>(in_0, tmp0);
        tout[1] = BlendIndex<1>(tmp0, in_0);
