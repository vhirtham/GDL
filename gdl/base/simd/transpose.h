...
//! @brief Transposes a matrix represented by a column major register array and writes it to the passed output array.
...
//! @param matDataO: Array containing the output matrix data
