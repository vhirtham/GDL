                      ...
                      __m256d& out3)
{
    ...
    out0 = _mm256_permute2f128_pd(tmp0, tmp2, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out1 = _mm256_permute2f128_pd(tmp1, tmp3, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out2 = _mm256_permute2f128_pd(tmp0, tmp2, PERMUTE_2F128_MASK(0, 1, 1, 1));
    out3 = _mm256_permute2f128_pd(tmp1, tmp3, PERMUTE_2F128_MASK(0, 1, 1, 1));
}
                      ...
                      __m256& out7)
{
    ...
    //     tmp0 = _mm256_shuffle_ps(out0,out2, SHUFFLE_4_MASK(0, 1, 0, 1));
    //     tmp1 = _mm256_shuffle_ps(out0,out2, SHUFFLE_4_MASK(2, 3, 2, 3));
    //     tmp2 = _mm256_shuffle_ps(out1,out3, SHUFFLE_4_MASK(0, 1, 0, 1));
    //     tmp3 = _mm256_shuffle_ps(out1,out3, SHUFFLE_4_MASK(2, 3, 2, 3));
    //     tmp4 = _mm256_shuffle_ps(out4,out6, SHUFFLE_4_MASK(0, 1, 0, 1));
    //     tmp5 = _mm256_shuffle_ps(out4,out6, SHUFFLE_4_MASK(2, 3, 2, 3));
    //     tmp6 = _mm256_shuffle_ps(out5,out7, SHUFFLE_4_MASK(0, 1, 0, 1));
    //     tmp7 = _mm256_shuffle_ps(out5,out7, SHUFFLE_4_MASK(2, 3, 2, 3));

    // Faster than pure shuffle. Have a look at the link in the function description
    tmpBlend = _mm256_shuffle_ps(out0, out2, SHUFFLE_4_MASK(2, 3, 0, 1));
    ...
    tmpBlend = _mm256_shuffle_ps(out1, out3, SHUFFLE_4_MASK(2, 3, 0, 1));
    ...
    tmpBlend = _mm256_shuffle_ps(out4, out6, SHUFFLE_4_MASK(2, 3, 0, 1));
    ...
    tmpBlend = _mm256_shuffle_ps(out5, out7, SHUFFLE_4_MASK(2, 3, 0, 1));
    ...
    out0 = _mm256_permute2f128_ps(tmp0, tmp4, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out1 = _mm256_permute2f128_ps(tmp1, tmp5, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out2 = _mm256_permute2f128_ps(tmp2, tmp6, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out3 = _mm256_permute2f128_ps(tmp3, tmp7, PERMUTE_2F128_MASK(0, 0, 1, 0));
    out4 = _mm256_permute2f128_ps(tmp0, tmp4, PERMUTE_2F128_MASK(0, 1, 1, 1));
    out5 = _mm256_permute2f128_ps(tmp1, tmp5, PERMUTE_2F128_MASK(0, 1, 1, 1));
    out6 = _mm256_permute2f128_ps(tmp2, tmp6, PERMUTE_2F128_MASK(0, 1, 1, 1));
    out7 = _mm256_permute2f128_ps(tmp3, tmp7, PERMUTE_2F128_MASK(0, 1, 1, 1));
}
