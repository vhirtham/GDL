...
//! @brief Returns a positive value if the point lies inside the circle described by the three points c0, c1 and c2. If
//! the returned value is 0, the point lies on the circles boundary. If the returned value is negative, the point lies
...
//! @return Positive value, if the point is inside the circle, 0 if it lies on the boundary and negative values
//! otherwise.
